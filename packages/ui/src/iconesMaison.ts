// packages/ui/src/iconesMaison.ts
//
// LES ICÔNES QUE LUCIDE N'A PAS.
//
// Le vocabulaire des repères (src/icones.ts) vient de lucide, et
...
// la carte du live, la palette du studio, et le canvas des planches (qui lit
// la géométrie via `iconNode`).
//
