...
export default function MapEmbed({
  ...
  // --- Rendu principal (même ergonomie que LiveTracking)
  return (
    <div
      className="relative w-full overflow-hidden shadow-md border border-gray-200 rounded-2xl"
      style={{
    ...
    >
      ...
      {/* Bouton Recentrer (icône en mobile, texte sur desktop) */}
      <button
        onClick={resetView}
