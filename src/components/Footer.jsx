      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
          ...
          <nav aria-label="Liens de pied de page" className="flex items-center gap-4 text-sm">
            ...
            <a className="underline-offset-4 hover:underline" href="/mentions-legales">Mentions légales</a>
            <a href="https://www.instagram.com/thelocomotionlab" target="_blank" rel="noreferrer" aria-label="Instagram" className="hover:text-brand-accent">
