    ...
    try {
      ...
      const res = await fetch("https://send-email.thelocomotionlab.workers.dev/", {
        ...
        body: JSON.stringify({
          ...
          message: htmlMessage,
          isHtml: true, // ⚠️ important pour dire au Worker d’interpréter le HTML
        }),
      });
      ...
      <main className="max-w-2xl mx-auto px-6 py-12 text-gray-800 font-sans">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className={`bg-brand-accent text-white font-semibold px-6 py-2 rounded-full shadow transition
              ${status === "sending" ? "opacity-70 cursor-wait" : "hover:bg-brand-primary/90"}
            `}
          >
