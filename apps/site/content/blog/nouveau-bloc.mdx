...
Ainsi, fort de cette aventure entre Vercors et Drôme (dont tu trouveras le récit [ici](/aventures/recit/vercors-2026)), et après une petite semaine de coupure au cours de laquelle j'ai pu festoyer mes 31 ans autour d'un bivouac entre amis, j'ai décidé de repartir à l'entraînement. Dans une optique cette fois plus structurée, pour continuer de me développer en tant qu'athlète, et tenter de repousser plus loin que je ne l'ai encore fait les curseurs de ma robustesse phjysiologique. Je m'explique.
...
<Protocole id="footing-a-jeun-prolonge"
...
<Protocole id="jeune-cetogene-apres-midi"
...
<Protocole id="descentes-glycogene-bas"
...
<Protocole id="train-low-eat-low"
...
<Protocole id="sortie-longue-cetogene"
