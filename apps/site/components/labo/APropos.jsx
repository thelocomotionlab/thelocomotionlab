...
export default function APropos() {
  return (
    <div className="max-w-[38em] space-y-4 font-lora text-lecture leading-loose text-brand-ink hyphens-auto [text-wrap:pretty]">
      <p className="m-0">
      ...
      <p className="m-0 pt-2 text-right font-lora text-2xl font-light not-italic text-brand-deep-dark">
        Valentin
      </p>
    </div>
  );
