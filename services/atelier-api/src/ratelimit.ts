// Limite de débit par IP, en mémoire (pattern services/live-journal, lui-même
// hérité d'email-gateway). Service mono-instance → pas besoin de partage
// d'état. L'horloge est injectable pour des tests déterministes.
